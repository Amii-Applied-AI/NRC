...
Description: Definition of customized performance metrics.         
"""
...
class BinaryClassificationMetric(Metric):
    ...
    def __init__(self,
        ...
        Args:
            ...
            to_maximize (bool): if True, indicates that the metric must be maximized.
                                Otherwise, it must be minimized.
            from_proba (bool): if True, the metric is calculated using the probabilities
                               predicted and not the binary classes.
        """
...
class F1Score(BinaryClassificationMetric):
    ...
    def __call__(predicted_values: array,
        ...
        Returns:
            float: F1-score
        """
        return skm.f1_score(targets, predicted_values, average='weighted')
