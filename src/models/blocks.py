...
from torch.nn import AvgPool1d, Conv1d, Conv2d, BatchNorm1d, Dropout, Dropout1d, GELU, \
    Identity, LeakyReLU, Linear, MaxPool1d, Module, ModuleList, Sequential, Softsign
...
class LinearBlock(Module):
    ...
    def __init__(self,
        ...
        Args:
            ...
            odd (bool, optional): if True, biases are removed and a 
                                  an odd activation function is used.
        """
        # Call parent's constructor
        Module.__init__(self)

        # Initialize a list of layers
        self.__layers = [Linear(in_features=in_features,
                                out_features=out_features,
                                bias=(not odd))]

        # Initialize a list of layers
        if odd:
            self.__layers.append(Softsign())
        else:
            self.__layers.append(GELU())
    ...
    def __init__(self,
        ...
        Args:
            ...
            add_residual (bool, optional): if True, add residual connection between the input
                                           ...
                                           Default to False.
            shrink_to_growth_rate (bool, optional): if True, apply a bottleneck to the input
                                                    so it has a number of channels equal 
                                                    to 'growth_rate'.
                                                    Default to False.
        """
        super().__init__()
...
class CNNBlock1D(Module):
    ...
    Conv1D -> BatchNorm1D -> GELU -> Dropout -> Pooling
    """
    def __init__(self,
                 in_channels: int,
                 out_channels: int,
